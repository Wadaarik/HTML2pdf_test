...
<page style="font-size: 14px">
    ...
    <br>
    Image : <img src="https://raw.githubusercontent.com/spipu/html2pdf/master/examples/res/logo.gif" alt="Logo" width=150 /><br>
    <br>
                    ...
                    <tr>
                        ...
                        <td style="border: solid 2px #000077; padding: 2mm">
                            <table style="border: solid 1px #445500">
                                <tr>
                                    <td>
                                        <img src="https://raw.githubusercontent.com/spipu/html2pdf/master/examples/res/logo.gif" alt="Logo" width=100 />
                                    </td>
                                </tr>
                            </table>
                        </td>
